...
## 📋 序號管理後台
- 本地：http://localhost:8080/admin/serials
- 測試：https://172.17.88.28/admin/serials
- 正式：http://缺/admin/serials
---
...
```
<img width="1888" height="941" alt="打包與佈署" src="https://github.com/user-attachments/assets/2f8b09fc-1de4-4a98-a0db-7b6f68f7c8a5" />
...
2. 如何確認 "活動唯一識別碼" 的合法性
3. 核銷序號之後的後續
4. 未來外包廠商製作的後台如何串接 "序號管理系統"，如何判斷登入方式或是帳號權限
